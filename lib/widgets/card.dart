  ...
  Widget build(BuildContext context) {
    return Container(
      decoration: BoxDecoration(
          ...
          border: Border.all(
            width: 1,
            color: const Color.fromRGBO(126, 163, 160, 1),
          )),
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
            ...
            height: 3,
            decoration: BoxDecoration(
              color: (completedTask / totalTasks) < 0.5
                  ? const Color.fromRGBO(228, 160, 159, 1)
                  : (completedTask / totalTasks) < 0.7
                      ? const Color.fromRGBO(254, 234, 163, 1)
                      : const Color.fromRGBO(152, 233, 182, 1),
            ),
            child: Row(
              children: [
                Container(
                  width:  MediaQuery.of(context).size.width * 0.3 * (completedTask / totalTasks),
                  color: (completedTask / totalTasks) < 0.5
